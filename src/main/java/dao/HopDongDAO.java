    ...
    public String addHopDong(HopDong hd, StringBuilder errorMessage) {
        ...
        try {
            ...
            for (ChiTietHD ct : hd.getDanhSachXeThue()) {
                ...
                // conn.rollback();
                // errorMessage.append("Xe " + ct.getTenXe() + " không ở trạng thái 'Sẵn sàng'
                // nên không thể thuê ngay");
                // return null;
                // }
                //
                try {
                    ...
                    if (errorMsg.contains("ORA-20006")) {
                        ...
                        errorMessage.append(
                                "Xe " + ct.getTenXe() + " không ở trạng thái 'Sẵn sàng' nên không thể thuê ngay");
                    } else {
