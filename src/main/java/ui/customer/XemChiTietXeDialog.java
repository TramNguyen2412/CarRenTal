...
//        
//        // Panel hình ảnh với bo góc
//        RoundedPanel imagePanel = new RoundedPanel(15);
//        imagePanel.setPreferredSize(new Dimension(380, 280));
//        imagePanel.setBackground(new Color(245, 245, 245));
//        imagePanel.setBorder(new LineBorder(new Color(230, 230, 230)));
...
//        
//        // Thông số kỹ thuật
//        RoundedPanel specPanel = new RoundedPanel(10);
...
//        addSpecDetail(specContent, "Màu xe", gioXe.getMauXe() != null ? gioXe.getMauXe() : "N/A");
...
//        
//        // Panel thông tin thuê xe
//        RoundedPanel bookingPanel = new RoundedPanel(10);
//        bookingPanel.setLayout(new BorderLayout(0, 15));
