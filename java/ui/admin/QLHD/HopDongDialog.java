...
//        
//        // Thêm các thành phần với styling cải thiện
//        // KHÁCH HÀNG
//        gbc.gridx = 0;
//        gbc.gridy = 0;
//        gbc.weightx = 0.2;
//        formPanel.add(createStyledLabel("Khách hàng:"), gbc);
//        
//        gbc.gridx = 1;
//        gbc.weightx = 0.7;
...
//        
//        // Nút thêm khách hàng
//        JButton btnAddKH = createStyledButton("Thêm KH", PRIMARY_COLOR);
...
//        gbc.gridy = 1;
//        gbc.weightx = 0.2;
//        formPanel.add(createStyledLabel("Nhân viên phụ trách:"), gbc);
//        
//        gbc.gridx = 1;
//        gbc.weightx = 0.7;
//        cboNhanVien = createStyledComboBox();
//        loadNhanVienToComboBox();
//        formPanel.add(cboNhanVien, gbc);
//        
//        // ĐỊA CHỈ GIAO
//        gbc.gridx = 0;
//        gbc.gridy = 2;
//        formPanel.add(createStyledLabel("Địa chỉ giao:"), gbc);
//        
//        gbc.gridx = 1;
//        txtDiaChiGiao = createStyledTextField();
//        formPanel.add(txtDiaChiGiao, gbc);
//        
//        // TRẠNG THÁI
//        gbc.gridx = 0;
...
//        
//        gbc.gridx = 1;
//        cboTrangThai = createStyledComboBox(new String[]{
//            "Chờ xác nhận", "Đã xác nhận", "Đang thuê", "Đã trả xe", "Đã hủy", "Hoàn thành"
//        });
//        formPanel.add(cboTrangThai, gbc);
//        
...
//        gbc.gridx = 0;
//        gbc.gridy = 4;
//        formPanel.add(createStyledLabel("Tổng tiền:"), gbc);
//        
//        gbc.gridx = 1;
...
//        JButton btnAddXe = createStyledButton("Thêm xe", PRIMARY_COLOR);
//        JButton btnEditXe = createStyledButton("Sửa", ACCENT_COLOR);
//        JButton btnRemoveXe = createStyledButton("Xóa", ERROR_COLOR);
//        
...
//        // Panel nút với gradient background
//        JPanel panel = new JPanel() {
//            @Override
...
//                    0, getHeight(), new Color(235, 235, 240)
//                );
//                g2d.setPaint(gp);
...
//            JDialog confirmDialog = new JDialog(this, "Xác nhận xóa", true);
...
//            
//            // Thông báo
//            JLabel msgLabel = new JLabel("<html>Bạn có chắc muốn xóa xe này khỏi hợp đồng?<br>Thao tác này không thể hoàn tác.</html>");
//            msgLabel.setFont(new Font(FlatRobotoFont.FAMILY, Font.PLAIN, 14));
...
//            
//            JButton btnNo = createStyledButton("Không", new Color(120, 120, 120));
//            JButton btnYes = createStyledButton("Có, xóa", ERROR_COLOR);
//            
...
//                    showNotification("Đã xóa xe khỏi hợp đồng");
//                }
...
//            showErrorDialog("Vui lòng điền đầy đủ thông tin", errorMessage.toString());
//            return;
//        }
//        
//        // Cập nhật thông tin hợp đồng
...
//        hopDong.setTrangThai(cboTrangThai.getSelectedItem().toString());
//        
//        // Lưu hợp đồng với animation loading
//        JDialog loadingDialog = showLoadingDialog("Đang xử lý...");
//        
//        // Sử dụng SwingWorker để thực hiện lưu trong background
...
//                        showSuccessDialog("Thành công", resultMessage);
//                        
//                        // Làm mới danh sách hợp đồng trong panel cha
//                        if (parent != null) {
//                            parent.loadDataToTable();
...
//                } catch (Exception e) {
//                    loadingDialog.dispose();
//                    showErrorDialog("Lỗi không xác định", e.getMessage());
//                }
//            }
//        };
//        
...
//    }
//    
//    // Các phương thức helper tạo component với style nhất quán
//    
...
//        comboBox.setFont(new Font(FlatRobotoFont.FAMILY, Font.PLAIN, 14));
...
//        ));
//        
//        JLabel lblLoading = new JLabel(message);
//        lblLoading.setFont(new Font(FlatRobotoFont.FAMILY, Font.BOLD, 14));
